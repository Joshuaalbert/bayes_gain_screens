from bayes_gain_screens.tomographic_models import DDTECKernel
from bayes_gain_screens.tests.common_setup import *
...
def test_grad(tf_session):
    ...
    with tf_session.graph.as_default():
        kern = DDTECKernel(a=250., b=100., fed_kernel=RBF(3, lengthscales=10.),
                           ref_direction=[0.5,0.5,np.sqrt(1 - 0.5**2 - 0.5**2)], resolution=4)
