...
def update_h5parm(old_h5parm, new_h5parm):
    ...
    :return:
    """
    logging.info("Updating {}".format(old_h5parm))
    ...
    logging.info("Created {}".format(new_h5parm))
    solsets = old.solsets
...
class DataPack(object):
    ...
    def __init__(self, filename, readonly=False):
        ...
        if readonly and not os.path.isfile(self.filename):
            raise IOError("File {} doesn't exist and requesting readonly".format(self.filename))
