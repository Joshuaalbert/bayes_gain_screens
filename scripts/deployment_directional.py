...
if __name__ == '__main__':
    datapack = DataPack('/home/albert/lofar1_1/imaging/data/P126+65_compact_raw/P126+65_full_compact_raw_v9.h5', readonly=False)
    ...
    deployment = Deployment(datapack,
                            ...
                            block_size = 10,
                            working_dir = './deployment_directional')
