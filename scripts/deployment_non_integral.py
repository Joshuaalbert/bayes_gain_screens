...
from bayes_filter.non_integral_models import generate_models
from bayes_filter.datapack import DataPack
from bayes_filter.misc import make_soltab
import numpy as np

if __name__ == '__main__':
    datapack = DataPack('/home/albert/lofar1_1/imaging/data/P126+65_compact_raw/P126+65_full_compact_raw_v10.h5', readonly=False)
    ...
    deployment = Deployment(datapack,
                            ...
                            block_size = 10,
                            working_dir = './deployment_non_integral')
